...
from environment.reward_perturbator import GaussianPerturbator, GreedyPerturbator, NoPerturbator
...
OPTIONS_USER_DATASET = ["detailed", "basic", "sampled"]
...
def get_base_parser():
    ...
    parser.add_argument(
        "--news-dataset",
        type=str,
        default="mind_dataset",
        choices=["mind_dataset"],
    )
    parser.add_argument(
        "--perturbator",
        type=str,
