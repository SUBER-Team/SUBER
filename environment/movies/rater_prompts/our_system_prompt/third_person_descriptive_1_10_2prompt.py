...
class ThirdPersonDescriptive110_2Shot_OurSys(ThirdPersonDescriptive110_OurSys):
    ...
    def _get_few_shot_prompts(self):
        if self.cache_few_shot_prompts is None:
            ...
            explanation2 = (
                "4 on a scale of 1 to 10, because Nicholas has a strong preference for"
                " adrenaline-inducing action, thriller, and horror movies, he would"
                ' likely rate the movie "La La Land" 4 out of 10. This is evident from'
                ...
                ' "Fifty Shades of Grey", received lower ratings, such as a 3. As "La'
                ...
                " rating of 7.9, Nicholas's preference for adrenaline-filled plots"
