...
class LowRatingStudy(AbstractCaseStudy):
    ...
    user_always1 = [
        User(
            ...
            (
                ...
                " disdain for watching films on television, considering it a wasteful"
                " use of time. Consequently, he consistently assigns a rating of 1 to"
                " every film, intending to convey his profound disrespect towards the"
                " medium."
            ),
        ),
        User(
            ...
            19,
            (
                "a young woman, who is visually impaired and unable to experience the"
                " visual aspects of films, has embraced a unique philosophy."
                " Recognizing her inability to fully enjoy movies, she has adopted a"
                " personal principle of assigning a rating of 1 to every film she"
                " watches. This practice reflects her perspective that, due to her"
                " visual impairment, she is unable to fully appreciate the cinematic"
                " experience."
            ),
        ),
        User(
            ...
            75,
            (
                "an old man holds a strong belief that films are excessively praised"
                ...
                " rating of 1 to every film he encounters as an expression of his"
                " conviction."
            ),
        ),
        User(
            ...
            (
                ...
                " film she watches. This deliberate act serves as her attempt to"
    ...
    def run(self):
        ...
        perc_success = (ratings <= np.full_like(ratings, 2)).mean()
        data["should_be"] = "<=2"
